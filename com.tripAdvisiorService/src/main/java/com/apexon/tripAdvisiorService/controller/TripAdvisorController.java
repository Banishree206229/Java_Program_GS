...
import com.apexon.tripAdvisiorService.feign.LongitudeLatitideInterface;
...
public class TripAdvisorController {
    ...
    private final LongitudeLatitideInterface longitudeLatitideInterface;
    ...
    public int save(@RequestBody TripAdvisorDto tripAdvisorDto) throws IOException {
        //List<LatitudeLongitudeResponse> sourceLatLong = longitudeLatitideInterface.searchLocation("json", tripAdvisorDto.getSource());
